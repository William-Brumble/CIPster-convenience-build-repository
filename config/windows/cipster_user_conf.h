 ...
 *
 * This file contains the general application specific configuration for
 * CIPster.
 *
 ...
 *    1. Explicit messages will use this buffer to store the data generated by
 * the request
...
// #define CIPSTER_WITH_TRACES
// #define CIPSTER_TRACE_LEVEL CIPSTER_TRACE_LEVEL_INFO
//
